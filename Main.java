...
public class Main {
  public static void main(String[] args) {
   ...
   //getting the data for the first car
    ...
    Car firstCar = new Car(plate1, col1, doors1, maxSpeed1);
    System.out.println("");
    
    //getting the data for the second car
    
    //getting the plate number
    System.out.print("Enter the plate number of the second car: ");
    ...
    do  {
      try {
        //get the number of doors
        System.out.print("How many doors does the second car have? ");
    ...
    Car secondCar = new Car(plate2, col2, doors2, maxSpeed2);
    
    //now seeing what the user wants to do with the cars
    do  {
      //ask the user what they want to do
      try {
        System.out.print("Enter 1 to modify car 1. Enter 2 to modify car 2. Enter 0 to exit: ");
        ...
        if (userChoice.equals("1")) {
          ...
          if (itemToEdit.equals("0")) {
            ...
            //get the max speed of the car
            secondCar.getMaxSpeed();
          } else if (itemToEdit.equals("4"))  {
            //change the plates
            secondCar.changePlates();
          } else  {
            throw new Exception("Invalid input");
          }
        }
